...
def randomPatient():
	...
	pat['index'] = randomString()
		...
		ChiefComplaint = t_pat['ChiefComplaint'] = dig_code
        	ana_pos = randomText(5, rad_words)
		TriageAssessment = t_pat['TriageAssessment'] = dig_code + ana_pos + randomText(10, wjn_words)
                tmp += TriageAssessment 
		MDcomments = t_pat['MDcomments'] = tmp + randomText(5, come_words)
		#MDcomments = t_pat['MDcomments'] = dig_code + ana_pos + randomText(20, come_words)
